...
from core.models import User, db_helper, Profile, Post, Order, Product, OrderProductAssociation


# cоздание пользователя,его сохранение
...
# поиск по username,добавить в admin аккаунт
...
# загрузка user с их постами и из постов с польщователями
...
# получение пользователя, потом пользователя,потом постов
...
#
#
# #добавление подарка для всех пользователей
